...
## Mobile APP (66屏)
5 Tabs + 61个功能页。Wave 1-4 深度升级后与 Web 对齐:
- 核心(12): 首页/圣地/AI/修行/我的 + 文化传统/祖庭/祖师/祖训/印/搜索/地图
- 行程路线(7): 行程列表/详情/创建, 路线列表/详情/结账, 套餐列表/详情
- 商业(11): 结账/支付结果/订单, 优惠券/促销, 会员/分销/积分商城, 价格日历/提醒/比较/趋势
- 社区(9): 攻略社区/攻略列表/详情/问答广场/详情/照片墙/排行榜/写攻略/写评价
- 圆满之路(11): 文化与生命/十二命题/命题详情/七阶段/AI圆桌/信仰力评估, 个人圆满主题/案例, 家庭幸福主题/案例, 团队文化
- 用户(6): 登录/注册/编辑资料/消息/聊天/通知, 用户主页, 关于/隐私/条款
- 集成: CrawlerVideos (YT 视频挂详情页), TpPackages (4档配套)
...
| F5 | 文化与生命(M40): 12命题×12文化×7阶段,Web 8页+Admin 4Tab+i18n | ✅ |
| F6 | Mobile 深度升级 4-Wave: 四部曲(文化生命/信仰力/个人/家庭) + 排行榜/用户主页 + CrawlerVideos/TpPackages + 31 新路由,66 屏对齐 Web | ✅ |
...
#13 天查++ (TC)    — 全维度代码审查框架,5层×18维(拓扑/图论/流/漂移/启发),与全审++双跑互补
...
#18 价格++ (PRC)   — 全站旅行价格单一事实源,3态透明(baseline/crawler/official)+3 CRON自愈+迭代升级,PRC-01~30,首发 PriceSnapshot 3003 条
```
