...
const SECTIONS = [
  {
    title: '一、服务说明',
    intro: '本平台致力于为用户提供全球文化圣地旅行服务，包括但不限于：',
    items: [
      '十二大文化传统知识展示与教育。',
      '全球300个文化圣地的信息查询与导览。',
  ...
  },
  {
    ...
    items: [
      '尊重文化传统：本平台涵盖多种文化传统，请尊重各文化传统，不得发布侮辱、歧视、攻击任何文化传统的内容。',
      '禁止不当内容：不得发布违法、淫秽、暴力、恐怖、虚假信息或侵犯他人合法权益的内容。',
      '文明交流：在使用AI助手和社区功能时，请保持文明、友善的交流态度，促进跨文化对话与理解。',
  ...
  },
  {
    ...
    items: [
      ...
      '您在本平台发布的文化之旅日志等用户生成内容，著作权归您所有。但您同意授予本平台非独占的、免费的许可，用于平台内展示和推广。',
    ],
  },
  {
    title: '七、免责声明',
    items: [
      '旅行风险：文化旅行可能存在固有风险，包括但不限于交通、天气、健康等方面的风险。用户应自行评估旅行风险并采取适当的安全措施。本平台建议您出行前购买旅行保险。',
      '信息准确性：本平台尽力确保所提供的文化传统信息的准确性，但不对其完整性、时效性作出保证。文化教义和文化内容仅供参考。',
      '第三方服务：本平台可能包含第三方服务的链接或接入，我们不对第三方服务的内容、安全性和可用性承担责任。',
      'AI助手：小鸿AI助手提供的信息仅供参考，不构成专业的文化、法律或医疗建议。',
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.card}>
        <Text style={styles.paragraph}>
          欢迎使用佳绩之旅（以下简称"本平台"）。本用户协议（以下简称"本协议"）是您与本平台运营方之间关于使用本平台各项服务的法律协议。请您在注册或使用本平台服务前，仔细阅读本协议的全部内容。如果您不同意本协议的任何条款，请勿注册或使用本平台。
        </Text>
      </View>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.contactBox}>
          <ContactRow label="平台名称" value="佳绩之旅" />
