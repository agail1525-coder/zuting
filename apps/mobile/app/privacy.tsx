...
const SECTIONS = [
  {
    ...
    items: [
      ...
      '行程数据：您创建的行程信息、文化之旅日志、浏览记录等，用于提供个性化服务。',
  ...
  },
  {
    title: '二、信息使用',
    items: [
      '提供核心服务：文化传统内容浏览、圣地查询、祖庭信息展示。',
      '行程管理：创建、管理和跟踪您的文化之旅行程，提供行程状态更新。',
      '支付处理：处理订单支付、退款及相关财务记录。',
      'AI助手服务：基于您的提问提供文化知识问答和行程建议。',
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.card}>
        <Text style={styles.paragraph}>
          佳绩之旅（以下简称"本平台"或"我们"）深知个人信息对您的重要性，并会尽全力保护您的个人信息安全可靠。我们致力于维持您对我们的信任，恪守以下原则保护您的个人信息：权责一致原则、目的明确原则、选择同意原则、最少够用原则、确保安全原则、主体参与原则、公开透明原则等。
        </Text>
        <Text style={styles.paragraph}>
