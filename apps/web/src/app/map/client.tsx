  ...
  return (
    <div className="fixed inset-0 top-16 flex">
      ...
      <div
        ...
        } transition-all duration-300 overflow-hidden bg-temple-900/95 backdrop-blur-xl border-r border-gold/10 flex flex-col z-10`}
      >
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-3 py-2 rounded-lg text-left transition-all ${
                      isActive
                        ? "bg-gold/10 text-temple-100"
                        : "text-temple-500 hover:text-temple-300 hover:bg-temple-800/50"
                    }`}
                  >
                    <span
                    ...
                    <span className="text-xs text-temple-500">{count}</span>
                  </button>
                );
              })}
            </div>
            ...
            <div className="border-t border-gold/10 pt-5">
              ...
              <div className="card-glow rounded-xl bg-temple-800/50 overflow-hidden">
                ...
                <h4
                  ...
                  style={{
                    color: selectedSite.religion?.color || "#D4A855",
                  }}
                >
                  {selectedSite.name}
                </h4>
                <p className="text-temple-400 text-sm mb-1">
                  {selectedSite.nameEn}
                </p>
                <p className="text-temple-500 text-xs mb-3">
                  {selectedSite.country}
                  {selectedSite.religion
                    ? ` · ${selectedSite.religion.name}`
                    : ""}
                </p>
                <p className="text-temple-300 text-sm leading-relaxed mb-3 line-clamp-3">
                  {selectedSite.description}
                </p>
                <div className="text-temple-500 text-xs mb-4">
      ...
      <button
        ...
        className="absolute top-4 z-20 bg-temple-800/90 backdrop-blur-sm border border-gold/20 text-gold p-2 rounded-lg hover:bg-temple-700/90 transition-all"
