...
import PureLandPatriarchDetailClient from "./detail-client";
...
export async function generateMetadata({
  ...
  try {
    ...
    return {
      title: `${p.name}${p.title ? " · " + p.title : ""} — 净土宗祖师 | JOINUS`,
    ...
    return { title: "净土宗祖师 | JOINUS" };
  }
}

export default async function PureLandPatriarchDetailPage({
  params,
}: {
  params: Promise<{ id: string }>;
}) {
  ...
  return <PureLandPatriarchDetailClient patriarch={patriarch} />;
}
