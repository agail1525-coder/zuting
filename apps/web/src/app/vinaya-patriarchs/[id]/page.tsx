...
import VinayaPatriarchDetailClient from "./detail-client";
...
export async function generateMetadata({
  ...
  try {
    ...
    return {
      title: `${p.name}${p.title ? " · " + p.title : ""} — 律宗祖师 | JOINUS`,
    ...
    return { title: "律宗祖师 | JOINUS" };
  }
}

export default async function VinayaPatriarchDetailPage({
  params,
}: {
  params: Promise<{ id: string }>;
}) {
  ...
  return <VinayaPatriarchDetailClient patriarch={patriarch} />;
}
