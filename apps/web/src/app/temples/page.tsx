...
export const metadata = {
  title: "全球27座祖庭 - 追溯文化源流",
  description:
    "探索全球27座祖庭，追溯各大文化传统的历史源流与文化根脉。Explore 27 ancestral temples worldwide, tracing the origins of world faiths.",
  openGraph: {
    title: "全球27座祖庭 - 文化源流 | 祖庭之旅",
    description: "探索全球27座祖庭，追溯各大文化传统的历史源流与文化根脉。",
