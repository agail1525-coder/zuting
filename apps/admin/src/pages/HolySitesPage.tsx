...
import { Table, Card, Typography, Select, Space, Tag, Button, Modal, Form, Input, InputNumber, Popconfirm, message } from 'antd';
...
export default function HolySitesPage() {
  ...
  const load = () => {
    setLoading(true);
    getHolySites(religionFilter).then(setData).finally(() => setLoading(false));
  };
