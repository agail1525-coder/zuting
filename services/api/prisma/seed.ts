...
- 路线推荐必须基于平台实际收录的产品数据`,
  ...
  const casesData = [
    ...
    {
      slug: 'case-school-ganen-2025', teamName: '某重点中学高三教师 30 人',
      orgType: 'SCHOOL' as const, industry: '教育',
      themeId: ganen?.id, headcount: 30,
      story: '在高考之前，30 位高三老师走进曲阜孔庙，进行 3 天"感恩之旅"。在大成殿前向至圣先师致敬，在杏坛之下重读《学记》。回校后教师们普遍反映在与学生沟通中更加从容、有耐心。',
      highlights: ['教师身心调整', '团队感恩文化', '回校后教学更从容'],
      photos: ['https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=800'],
      testimonial: '我重新理解了"师者"二字。— 校长',
      consentSigned: true, isPublished: true, publishedAt: new Date(),
    },
  ];
