...
export const RELIGION_BUSINESS_CONTENT: Record<string, ReligionBusinessContent> = {
  buddhism: {
    ...
    businessInsight: '稻盛和夫将佛教"利他"哲学注入京瓷与KDDI，创造两家世界500强。乔布斯的禅修习惯直接影响了苹果"少即是多"的产品哲学。正念已成为硅谷高管的标配修行，帮助领导者在信息洪流中保持清明决策力。',
  },
  ...
  christianity: {
    ...
    businessInsight: '沃尔玛创始人山姆·沃尔顿将基督教仆人精神融入零售帝国——"超越顾客期望"。万豪酒店的"以人为本"文化直接源于创始人的基督教信仰。美国企业界的慈善传统(洛克菲勒、卡内基、盖茨)也深植于基督教的"管家"观念——财富是上帝的托付，而非个人的所有。',
  },
  ...
  judaism: {
    ...
    businessValues: [
      ...
      { key: 'talmudic_debate', label: '塔木德辩证', description: '犹太教育鼓励质疑和辩论——"两个犹太人三个观点"。这种辩证思维是以色列创新之国的文化根基' },
  ...
  sikhism: {
    ...
    businessValues: [
      { key: 'equality_leadership', label: '平等领导', description: '锡克教"兰加尔"(共食)传统——无论身份地位一律平等用餐。消除等级的扁平化管理在此有千年原型' },
      { key: 'honest_labor', label: '诚实劳动', description: '"Kirat Karo"(诚实劳动)是锡克教三大支柱之一。靠投机取巧获利在锡克商业伦理中是不道德的' },
  ...
  shinto: {
    ...
    businessValues: [
      { key: 'monozukuri', label: '匠心经营', description: '神道教"物造"精神追求极致完美。日本拥有全球最多的百年企业(33,000+家)，秘密就是不求大、但求精' },
    ...
    businessInsight: '日本百年企业密度全球第一(33,000+家)，千年企业也有7家。金刚组(建筑公司，公元578年创立)存续近1,500年的秘密就是神道教的"匠人精神"——不追求规模扩张，专注把一件事做到极致。丰田的"现地现物"、索尼的"工匠魂"、无印良品的"素之美"，都是神道文化的商业化表达。',
  },
  ...
  'tibetan-buddhism': {
    ...
    businessValues: [
      ...
      { key: 'adversity_transform', label: '转化逆境', description: '藏传佛教的"转烦恼为菩提"思想——每一次危机都是转型的契机，每一个障碍都是成长的台阶' },
      { key: 'bodhichitta', label: '菩提心愿', description: '发愿利益一切众生——企业的终极使命应超越利润，指向更广泛的社会福祉' },
    ],
    businessInsight: '达赖喇嘛与商界领袖的对话已成为达沃斯论坛的固定节目。"慈悲领导力"理论被哈佛商学院、沃顿商学院纳入MBA课程。Salesforce创始人马克·贝尼奥夫的"利益相关者资本主义"理念深受藏传佛教影响。冥想App(Headspace、Calm)的数十亿美元估值证明了冥想商业化的巨大潜力。',
  },
  ...
  bahai: {
    ...
    businessValues: [
      { key: 'global_vision', label: '全球视野', description: '巴哈伊教"地球是一个国家，人类是其公民"的理念，是跨国企业全球化治理的哲学根基' },
      { key: 'consultation', label: '协商共治', description: '巴哈伊的"磋商"制度——决策时每个参与者都必须充分表达，一旦达成共识则全体执行。超越了简单多数决的局限' },
      { key: 'diversity_inclusion', label: '多元包容', description: '巴哈伊教义核心是消除一切偏见(种族/性别/阶级)。DEI(多元、平等、包容)战略的精神先驱' },
      { key: 'science_religion', label: '科教融合', description: '巴哈伊教强调科学与信仰必须和谐——数据驱动与价值驱动并重，理性决策与道德判断合一' },
    ],
    businessInsight: '巴哈伊社区遍布全球200+国家和地区，其"磋商"制度被联合国和多个国际组织采纳为决策参考模型。巴哈伊教义中"消除极端贫富差距"的经济思想，与当代"包容性增长"理念高度吻合。在全球化企业面临文化冲突加剧的今天，巴哈伊"多元统一"的哲学提供了独特的解决框架。',
  },
};
