...
const themesData: Array<{
  ...
  // ════════ 01 同心之旅 ════════
  {
    slug: 'tongxin',
    title: '同心之旅',
    subtitle: '让团队在文化之旅中凝聚 · 凝聚力维度',
    description:
      '通过共同文化之旅、共修仪式与团体禅行,让组织成员在天地祖庭面前回到同一颗初心,凝聚团队共识。这是一次为期 4 天的深度文化工程,我们用十余项嵌入式仪式,把"凝聚力"从一句口号变成可触摸、可记忆、可代代传承的组织资产。',
    color: '#3264ff',
    icon: '☯',
    coverUrl: 'https://images.unsplash.com/photo-1480796927426-f609979314bd?w=1600',
    keywords: ['凝聚', '共识', '同行', '战略对齐'],
    holySites: ['shaolin-temple', 'wudang-mountain'],
    routes: [],
    rituals: [
      { name: '入山开光礼', durationMin: 45, description: '到达祖庭后的开光仪式,正式从世俗工作模式切换为文化之旅模式' },
    ...
    richContent: {
      ...
      philosophy: {
        title: '12 大文化传统中的"和合一处"哲学',
        body: '凝聚力不是被管理出来的,是被仪式化出来的。从孔子到禅宗,从基督文化的圣餐到伊斯兰的礼拜,所有延续千年的组织都有一个共同点:他们用反复的、身体在场的、共同的仪式,把抽象的信念铸成肉身记忆。少林千余年的武僧团之所以"令行禁止",不是因为戒律严苛,而是因为他们每天五点敲钟、共诵、共行——日复一日的"同"。',
        quotes: [
      ...
      gallery: [
        ...
        'https://images.unsplash.com/photo-1493514789931-586cb221d7a7?w=1200',
        'https://images.unsplash.com/photo-1466354424719-343280fe118b?w=1200',
      ],
    },
    priceFrom: 488000,
    durationDays: 4,
  ...
  // ════════ 02 感恩之旅 ════════
  {
    ...
    richContent: {
      ...
      philosophy: {
        title: '12 大文化传统中的"感恩"是组织底层操作系统',
        body: '从孔子的《孝经》到佛教文化的"上报四重恩"(父母/师长/众生/国土),从基督文化的"凡事谢恩"到伊斯兰的"赞美归于真主"——所有延续千年的文明,都把"感恩"放在价值观第一位。因为感恩是唯一能对抗"骄傲"的力量,而骄傲是所有大企业最终衰落的根本原因。日本京瓷的稻盛和夫每天对员工说"感谢",这不是情商,这是经营哲学。',
        quotes: [
      ...
      gallery: [
        'https://images.unsplash.com/photo-1518562180175-34a163b1a9a6?w=1200',
  ...
  // ════════ 03 传承之旅 ════════
  {
    ...
    color: '#1e4dcc',
    icon: '✦',
    coverUrl: 'https://images.unsplash.com/photo-1583417319070-4a69db38a482?w=1600',
  ...
  // ════════ 04 匠心之旅 ════════
  {
    ...
    richContent: {
      ...
      philosophy: {
        ...
        body: '《考工记》说"知者创物,巧者述之",中国早在 2000 年前就把"工匠精神"写进经典。日本把这种精神延续了千年——法隆寺的木构在没有水泥钢筋的时代屹立 1300 年,靠的是宫大工对每一个榫卯的极致专注。庄子讲"庖丁解牛"——技进乎道。当一个人把专业做到极致,工艺就变成了道,就变成了文化。我们带团队去法隆寺,不是看古董,是去重新点燃那团火。',
        quotes: [
      ...
      gallery: [
        ...
        'https://images.unsplash.com/photo-1542728928-1413d1894ed1?w=1200',
        'https://images.unsplash.com/photo-1552248524-10d9a7e4841c?w=1200',
  ...
  // ════════ 05 慈悲之旅 ════════
  {
    ...
    description:
      '把团建变成公益。施食、放生、捐书、助学,在文化之旅中沉淀团队的慈悲底色。这是一次为期 3 天的"意义感"工程,我们带团队走进尼泊尔蓝毗尼(佛陀诞生地),把 ESG 战略从一份报告变成全员可亲身参与的、真实改变他人命运的行动。',
    color: '#4a7aff',
    icon: '✧',
    ...
    richContent: {
      ...
      philosophy: {
        title: '12 大文化传统中的"慈悲"是组织的意义引擎',
        body: '佛教文化讲"无缘大慈,同体大悲"——不是因为有缘才慈悲,是无条件的慈悲;不是同情他人,是知道众生与我本是一体。基督讲"爱人如己",伊斯兰把"天课"(zakat)定为五功之一,儒家说"老吾老以及人之老"。所有伟大的文明都把"利他"放在意义的最高位。日本京瓷的稻盛和夫说"利他即利己,这是宇宙的法则"——真正长青的企业,都是慈悲驱动型的。',
        quotes: [
  ...
  // ════════ 06 坚毅之旅 ════════
  {
    ...
    description:
      '为挑战中的团队设计:高山、夜行、守夜、断食小修。让组织在身体与意志的考验中重新出发。这是一次为期 6 天的极限韧性工程,我们带核心团队走入沙特圣地文化之旅路线,通过沙漠静默、高山徒步、断食守夜——所有人类文化传统中最严酷的修炼方式——把团队从困境的灰烬中重新点燃。',
    color: '#1e4dcc',
    icon: '✶',
    ...
    rituals: [
      ...
      { name: '凯旋归来', durationMin: 60, description: '文化探访证书颁发 + 集体合影' },
    ],
    richContent: {
      ...
      philosophy: {
        title: '12 大文化传统中的"苦修"是重生的火炼',
        body: '《孟子》说"天将降大任于斯人也,必先苦其心志,劳其筋骨,饿其体肤,空乏其身"。伊斯兰的"圣战"(jihad)真正的内涵是"克己之战"。佛教文化说"难行能行,难忍能忍"。《周易》说"天行健,君子以自强不息"。所有伟大的文明都告诉我们一件事:真正的重生,必须经过身体的火炼。一次极限的、让全身每一个细胞都参与的考验,胜过 100 次会议室里的鼓舞。',
        quotes: [
  ...
  const casesData = [
    {
      ...
      headcount: 50,
      story:
        '在连续加班半年后,技术中台团队来到少林寺与武当山,进行了为期 4 天的"同心之旅"。从晨钟到暮鼓,从齐诵祖训到同行登山,团队在文化之旅的每一步中重新找到工作之外的连接。回到岗位后,技术债清理速度提升 40%,离职率下降明显。',
    ...
    },
    {
      ...
      headcount: 22,
      story:
        '在尼泊尔蓝毗尼文化之旅期间,公益基金会的项目组完成了为期 3 天的"慈悲之旅"。施食、捐书、助学,从被动执行项目转向主动发心助人。回到工作中,项目执行效率与团队凝聚力同步提升。',
