...
async function bootstrap() {
  ...
  const config = new DocumentBuilder()
    .setTitle('佳绩之旅 Global Ancestral Temple Travel Platform API')
    .setDescription(
      '佳绩之旅平台 API — 帮助100万人走祖庭，建立全球文化和平使者网络。\n\n' +
      'JiaJi Travel Platform API — Helping 1 million people visit ancestral temples, ' +
      'building a global network of cultural peace ambassadors.\n\n' +
      '## Features / 功能\n' +
      '- **12 Cultural Traditions** (12大文化传统): Buddhism, Taoism, Christianity, Islam, Hinduism, Judaism, Confucianism, Sikhism, Shinto, Tibetan Buddhism, Indigenous Spirituality, Bahá\'í Faith\n' +
      '- **60 Holy Sites** (60圣地): 5 per cultural tradition with GPS coordinates\n' +
      '- **27 Ancestral Temples** (27祖庭): Key ancestral temples across all traditions\n' +
      '- **28 Patriarchs** (28祖师): Founders and key figures of each tradition\n' +
      ...
      '- **Cultural Journey Journals** (文化之旅日志): User travel journals\n\n' +
      '## Authentication\n' +
    ...
    .addTag('religions', 'CRUD for the 12 cultural traditions with multilingual names, symbols, and theme colors. / 12大文化传统的增删改查，支持多语言名称、符号与主题色。')
    .addTag('holy-sites', 'Sacred sites across all cultural traditions with GPS coordinates, UTC offsets, and rich descriptions. / 各文化传统圣地管理，包含GPS坐标、UTC偏移与详细描述。')
    .addTag('temples', 'Ancestral temples — key spiritual heritage sites for each cultural tradition. / 祖庭管理——各文化传统重要精神遗产圣地。')
    .addTag('patriarchs', 'Founders and key figures of each cultural tradition with biographical information. / 各文化传统创始人及重要人物传记信息。')
    ...
    .addTag('journals', 'Cultural journey journal entries with mood tracking, photo uploads, and public/private visibility. / 文化之旅日志，支持心情记录、照片上传与公开/私密设置。')
