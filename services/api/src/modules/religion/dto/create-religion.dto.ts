...
export class CreateReligionDto {
  @ApiProperty({
    description: 'Chinese name of the religion. / 文化传统中文名称',
    example: '佛教',
  })
  @IsString()
  name: string;
  ...
  @ApiProperty({
    description: 'English name of the religion. / 文化传统英文名称',
    example: 'Buddhism',
  })
  @IsString()
  nameEn: string;
  ...
  @ApiPropertyOptional({
    description: 'Unicode symbol or emoji representing this religion. / 代表该文化传统的Unicode符号或表情',
    example: '☸',
  })
  @IsOptional()
  @IsString()
