...
#### Wave 2 — 丰富度增强 (✅ 已实施)
8. ✅ **宗教关联** — 信仰图标+名称+链接到信仰详情页 (差异化)
9. ✅ **出行贴士增强** — 已有tips板块,保持现有实现 (差异化)
10. ✅ **分享按钮** — ShareButton已在Wave1预订区接入 (对标Airbnb)
11. ✅ **稀缺性提示** — 红色脉冲"仅剩少量名额"+预订数 (对标Priceline/Agoda)
12. ✅ **积分显示** — "预订可赚X积分"动态计算(5%回馈) (对标Expedia/Agoda)
13. ✅ **FAQ折叠面板** — 6问6答手风琴组件 (对标TripAdvisor)

#### Wave 3 — 体验级升级 (✅ 已实施)
14. ✅ **多媒体导览** — MediaTour组件接入ROUTE(视频+全景+音频) (差异化)
15. ✅ **相关祖师/祖训** — RelatedCulture组件(按religionId加载祖师+祖训卡片) (差异化)
16. ✅ **朝圣者日志** — 渐变CTA引导区"查看朝圣者日志" (差异化)
17. ✅ **小鸿AI浮窗** — XiaohongFloat组件(浮动按钮+快捷问题面板+路线上下文预设) (差异化)
